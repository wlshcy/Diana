...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            cell.textLabel.text = @"配送频次";
            cell.textLabel.font = FONT(16);
            cell.textLabel.textColor = GRAY_COLOR;
            cell.detailTextLabel.text = [NSString stringWithFormat:@"一周%@次", _item[@"freq"]];
            ...
            cell.textLabel.font = FONT(16);
            cell.textLabel.textColor = GRAY_COLOR;
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@斤", _item[@"weight"]];
            cell.detailTextLabel.textColor = RGB_COLOR(0, 0, 0);
            cell.detailTextLabel.font = FONT(16);
            cell.detailTextLabel.textColor = GRAY_COLOR;
            cell.accessoryType = UITableViewCellAccessoryNone;
            ...
            cell.textLabel.font = FONT(16);
            cell.textLabel.textColor = GRAY_COLOR;
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@人", _item[@"num"]];
            cell.detailTextLabel.textColor = RGB_COLOR(0, 0, 0);
            cell.detailTextLabel.font = FONT(16);
            cell.detailTextLabel.textColor = GRAY_COLOR;
            cell.accessoryType = UITableViewCellAccessoryNone;
...
- (void)getComboDetail
{
    ...
    [HTTPManager showCombo:self.cid success:^(NSDictionary *response) {
...
//        _carBtn.frame =CGRectMake(10, 5, SCREEN_WIDTH - 20, 45);
    }
    return _carBtn;
}
