...
- (void)layoutSubviews
{
    ...
    self.countLabel.frame = CGRectMake(self.addBtn.left-30, self.addBtn.top, 30, 35);
    self.subBtn.frame = CGRectMake(self.countLabel.left-32, self.nameLabel.bottom+25, 35, 35);
